...
## Q1
**Task:** Q1: Naive Bayes (attribute selection compare; confusion matrix & accuracy).
...
## Q2
**Task:** Q2: C4.5 (attribute & instance selection compare; explain decision tree) OR Neural network (explain & confusion matrix).
