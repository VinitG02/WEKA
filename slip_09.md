...
## Q1
**Task:** Q1: Apply J48 on iris.arff, report accuracy and visualize tree.
...
## Q2
**Task:** Q2: Naive Bayes on weather.nominal.arff (note accuracy) OR KNN on iris.arff (k=3 vs k=5 compare).
