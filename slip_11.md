...
## Q1
**Task:** Q1: Hierarchical clustering on iris.arff (dendrogram interpretation).
...
## Q2
**Task:** Q2: Identify top 3 attributes from Cancer.arff using WEKA OR Apriori on weather.nominal.arff with min support 0.5 (effect).
