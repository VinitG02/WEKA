...
## Q1
**Task:** Q1: Linear regression on airline dataset (note accuracy).
...
## Q2
**Task:** Q2: Naive Bayes on weather.nominal.arff OR classification using KNN on heart disease dataset.
