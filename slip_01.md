...
## Q1
**Task:** Q1: Naive Bayes classification (note accuracy; confusion matrix; accuracy formula).
...
## Q2
**Task:** Q2: Neural network classification (attribute selection and compare accuracy).
