...
## Q1
**Task:** Q1: J48 on cancer.arff with 10-fold CV (compare to training on full dataset).
...
## Q2
**Task:** Q2: Random Forest and J48 on iris.arff compare OR k-Means k=3 on iris (centroids).
