...
## Q1
**Task:** Q1: Hierarchical clustering (note accuracy).
...
## Q2
**Task:** Q2: Density-Based clustering (note accuracy) OR develop classification model using attribute and instance selection.
