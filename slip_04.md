...
## Q1
**Task:** Q1: Naive Bayes (with attribute selection compare; confusion matrix & accuracy).
...
## Q2
**Task:** Q2: Neural network (confusion matrix & accuracy) OR K-Means on sales dataset (elbow).
