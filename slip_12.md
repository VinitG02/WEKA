...
## Q1
**Task:** Q1: Apriori on supermarket.arff (frequent itemsets; usefulness).
...
## Q2
**Task:** Q2: Naive Bayes on cancer.arff (confusion matrix; precision & recall) OR J48 and ROC on weather.nominal.arff.
