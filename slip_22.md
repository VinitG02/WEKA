...
## Q1
**Task:** Q1: J48 on iris.arff (report accuracy & visualize tree).
...
## Q2
**Task:** Q2: Naive Bayes on weather.nominal.arff OR compare Naive Bayes, C4.5, Neural Network on common dataset.
