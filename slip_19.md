...
## Q1
**Task:** Q1: K-Means/ Hierarchical on sales_data_sample.csv (elbow).
...
## Q2
**Task:** Q2: Effect of attribute selection on accuracy (Adult dataset) OR Compare Naive Bayes, C4.5, Neural Network.
